    ...
    <div dir="rtl" className="min-h-screen bg-gray-100 p-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <h2 className="text-3xl font-semibold text-gray-800">
          {activeTab === "homepage" ? "🎨 أداة تخصيص الصفحة الرئيسية" : "👑 إدارة المستخدمين والصلاحيات"}
        </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        {/* Settings Panel */}
        <div className={`bg-white rounded-2xl shadow p-6 ${isAdmin ? "lg:col-span-3" : "lg:col-span-4"}`}>
          {!isAdmin && currentUser && !selectedUser && (
            <div className="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-blue-800">تخصيص صفحتك الرئيسية: <strong>{currentUser.username}</strong></p>
              <button
