...
export default function UploadExcel() {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-slate-900 shadow-lg rounded-2xl p-8 mt-6 border border-gray-200">
      ...
      <p className="text-gray-500 mb-6">
        ...
        تحميل ملف اكسل (.xlsx أو .xls) لاستيراد سجلات الموظفين إلى النظام.
      </p>
