// Permission definitions with Arabic labels and descriptions
export const permissionDefinitions = {
  ...
  "incidents.view": {
    key: "incidents.view",
    label: "عرض الحوادث",
    description: "القدرة على عرض قائمة الحوادث والتقارير",
    category: "الحوادث",
    action: "عرض",
  },
  "incidents.edit": {
    key: "incidents.edit",
    label: "تعديل الحوادث",
    description: "القدرة على تعديل تفاصيل الحوادث",
    category: "الحوادث",
    action: "تعديل",
  },
  "incidents.delete": {
    ...
    label: "حذف الحوادث",
    description: "القدرة على حذف سجلات الحوادث",
    category: "الحوادث",
    action: "حذف",
  },
  "incidents.create": {
  ...
  "salary.view": {
    key: "salary.view",
    label: "عرض الرواتب",
    description: "القدرة على عرض بيانات الرواتب",
    category: "الرواتب",
    action: "عرض",
  },
  "salary.edit": {
    key: "salary.edit",
    label: "تعديل الرواتب",
    description: "القدرة على تعديل بيانات الرواتب",
    category: "الرواتب",
    action: "تعديل",
  },
  ...
  "rewards.view": {
    key: "rewards.view",
    label: "عرض الحوافز",
    description: "القدرة على عرض الحوافز والمكافآت",
    category: "الحوافز",
    action: "عرض",
  },
  "rewards.edit": {
    key: "rewards.edit",
    label: "تعديل الحوافز",
    description: "القدرة على تعديل الحوافز والمكافآت",
    category: "الحوافز",
    action: "تعديل",
  },
  "rewards.create": {
  ...
  "punishments.view": {
    ...
    label: "عرض الجزاءات",
    description: "القدرة على عرض الجزاءات والعقوبات",
    category: "الجزاءات",
    action: "عرض",
  },
  "punishments.edit": {
    key: "punishments.edit",
    label: "تعديل الجزاءات",
    description: "القدرة على تعديل الجزاءات والعقوبات",
    category: "الجزاءات",
    action: "تعديل",
  },
  "punishments.create": {
...
export const getPermissionsByCategory = (category) => {
  return Object.values(permissionDefinitions).filter(
...
export const getAllCategories = () => {
  return [
    ...new Set(
      Object.values(permissionDefinitions).map((perm) => perm.category)
    ),
  ];
};

export const getPermissionByKey = (key) => {
  return permissionDefinitions[key];
};
